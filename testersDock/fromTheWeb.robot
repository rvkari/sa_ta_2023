### This example on the web is for showing how detailed API test could be done. However, the API located https://www.metaweather.com has changed and those tests cannot be excecuted
